...
namespace Monitor
{
    public class MysqlDBUtil
    {
        ...
        public MysqlDBUtil(string connection)
        {
        ...
        private void PrepareCommand(MySqlCommand cmd, MySqlConnection conn, MySqlTransaction trans, string cmdText, Object[] cmdParms)
        {
        ...
        private MySqlCommand BuildQueryCommand(MySqlConnection connection, string storedProcName, Object[] parameters)
        {
        ...
        private MySqlCommand BuildIntCommand(MySqlConnection connection, string storedProcName, Object[] parameters)
        {
            MySqlCommand command = BuildQueryCommand(connection, storedProcName, parameters);
        ...
        /// <returns></returns>
        public DataTable GetNewDataTable(MySqlDataReader dataReader)
        {
